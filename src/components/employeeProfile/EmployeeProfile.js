  ...
  useEffect(() => {
    ...
    const fetchUserData = async () => {
      try {
        ...
        try {
          const profileResponse = await axios.get(`  http://54.84.254.221/api/employees/${email}/`, {
            headers: {
              Authorization: `Token ${token}`,
            },
          });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (profileExists) {
        ...
        await axios.put(`  http://54.84.254.221/api/employees/${user.email}/`, formData, {
          headers: {
        ...
        await axios.post('  http://54.84.254.221/api/employees/', formData, {
          headers: {
            Authorization: `Token ${authToken}`,
            'Content-Type': 'multipart/form-data',
          },
      ...
      const profileResponse = await axios.get(`  http://54.84.254.221/api/employees/${user.email}/`, {
        headers: {
          Authorization: `Token ${authToken}`,
        },
      });
