  ...
  useEffect(() => {
    ...
    const fetchUserData = async () => {
      try {
        ...
        try {
          const profileResponse = await axios.get(`  https://api.onese.shop/api/employees/${email}/`, {
            headers: {
              Authorization: `Token ${token}`,
            },
          });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (profileExists) {
        ...
        await axios.put(`  https://api.onese.shop/api/employees/${user.email}/`, formData, {
          headers: {
        ...
        await axios.post('  https://api.onese.shop/api/employees/', formData, {
          headers: {
            Authorization: `Token ${authToken}`,
            'Content-Type': 'multipart/form-data',
          },
      ...
      const profileResponse = await axios.get(`  https://api.onese.shop/api/employees/${user.email}/`, {
        headers: {
          Authorization: `Token ${authToken}`,
        },
      });
