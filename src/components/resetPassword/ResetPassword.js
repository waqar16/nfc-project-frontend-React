...
const ResetPassword = () => {
  ...
  const resendEmail = async () => {
    ...
    try {
      await axios.post('  https://letsconnect.onesec.shop/auth/users/resend_activation/', { email });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post('  https://letsconnect.onesec.shop/auth/users/reset_password/', { email });
