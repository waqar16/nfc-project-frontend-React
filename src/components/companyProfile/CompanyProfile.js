...
const CompanyProfile = () => {
  ...
  useEffect(() => {
    ...
    const fetchCompanyData = async () => {
      try {
        ...
        try {
          setLoading(true)
          const companyResponse = await axios.get(`https://api.onese.shop/api/companies/${userId}/`, {
            headers: {
              Authorization: `Token ${token}`,
            },
          });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (profileExists) {
        await axios.put(`https://api.onese.shop/api/companies/${userId}/`, company, {
          headers: {
        ...
        const createResponse = await axios.post('https://api.onese.shop/api/companies/', company, {
          headers: {
            Authorization: `Token ${authToken}`,
          },
        });
