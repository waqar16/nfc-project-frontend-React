...
const Activation = () => {
  ...
  const handleActivation = async () => {
    try {
      ...
      const response = await axios.post('https://54.84.254.221/auth/users/activation/', {
        uid,
        token,
      });
      ...
      if (response.status === 204) {
        ...
        // // Login user
        // const loginResponse = await axios.post('  https://54.84.254.221/auth/token/login/', {
        //   email,
        //   password,
        // });
    ...
    //           }
    //           await axios.post('  https://54.84.254.221/api/profile_type/', profile, {
    //             headers: {
    //               Authorization: `Token ${authToken}`,
    //             },
    //           });
